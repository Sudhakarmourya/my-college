<%-- 
    Document   : alogin
    Created on : 13 Aug, 2019, 4:57:00 PM
    Author     : user
--%>
            ...
            <div class="col-sm-12 pic">
                <div class="row">
                    <div class="col-sm-12 pic1">
                        <b style="font-size:35px; ">ADMIN LOGIN</b><br/>
                        <b><a style="color:white;"href="index.jsp">HOME</a>&nbsp;/&nbsp;LOGIN</b>
                    </div>
                </div>
            </div>
             <div class="col-sm-12 log">
                     <div class="text-center"><h1><b style=" color:orange;">ADMIN</b><b style="color:blue">LOGIN</b></h1> </div>
