...
public class student extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String name,birth,email,num,gen,pass,add,city,pin,course,upload;
             ...
             Part p1=request.getPart("upload");
              String filename=p1.getSubmittedFileName();
               DbManager db=new DbManager();
                 String cmd="insert into student (n,email,dob,mobile_no,gender,passwd,address,city,pincode,course,pic,cdate)values('"+name+"','"+email+"','"+birth+"','"+num+"','"+gen+"','"+pass+"','"+add+"','"+city+"','"+pin+"','"+course+"','"+filename+"',curdate())";
