package org.apache.jsp.studentzone.code;
...
public final class cpcode_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String cmd="update student set password='"+newpass+"' where username='"+session.getAttribute("studentzone")+"' and password='"+oldpass+"'";
